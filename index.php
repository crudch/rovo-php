...
$ads = [
    ...
    [
        'Название' => 'Курта для сноуборда DC Mutiny Charocal',
        'Категория' => 'Одежда',
        'Цена' => '7500',
            ...
            <?php foreach ($ads as $ad) : ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?php echo $ad['URL картинки']; ?>" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?php echo $ad['Категория']; ?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?php echo $ad['Название']; ?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?php echo sumFormat($ad['Цена']); ?></span>
                            </div>
