...
$user_name = 'RoVo'; // укажите здесь ваше имя
$categories = [
    'Доски и лыжи',
    'Крепления',
    'Ботинки',
        ...
        <nav class="user-menu">
            <?php if($is_auth) : ?>
                <div class="user-menu__image">
                    <img src="<?php echo $user_avatar; ?>" width="40px" height="40px" alt="Пользователь">
                </div>
            ...
            <?php foreach ($ads as $ad) : ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?php echo $ad['image_url']; ?>" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?php echo $ad['category']; ?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?php echo $ad['name']; ?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?php echo sumFormat($ad['cost']); ?></span>
                            </div>
